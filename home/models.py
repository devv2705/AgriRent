...
class Message(models.Model):
    ...
    receiver = models.ForeignKey(farmer, on_delete=models.CASCADE, related_name='received_messages')
    equipment = models.ForeignKey(shared_equipment, on_delete=models.CASCADE)
